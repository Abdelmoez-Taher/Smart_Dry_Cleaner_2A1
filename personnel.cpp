...
bool personnel:: ajouter()
{
    ...
    query.prepare("INSERT INTO PERSONNEL (CIN,NOM,PRENOM,DATE_NAISSANCE,ADRESSE,NUM_TEL) "
                        "VALUES ( :cin,:nom,:prenom,:date_naissance,:adresse,:num_tel)");
...
{QSqlQuery query;
         ...
         query.prepare("UPDATE PERSONNEL set CIN=:cin,ADRESSE=:adresse,NUM_TEL=:num_tel where CIN= :cin ");
         query.bindValue(":cin",cin);
         query.bindValue(":adresse",adresse);
query.bindValue(":num_tel",num_tel);
