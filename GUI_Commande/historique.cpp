...
{    QFile file ("C:/Users/moezt/Desktop/2021-2022/2A(moez)/2eme semestre/Projet C++/Commande/Realisation_Implementation/GUI_Commande/Historique.txt");
     if (!file.open(QIODevice::WriteOnly|QIODevice::Append | QIODevice::Text))
      qDebug()<<"erreur";
     QTextStream out(&file);
     QString sDate = QDateTime::currentDateTime().toString("dddd dd MMMM yyyy hh:mm:ss.zzz");
...
void Historique::save0(QString CIN,QString NOM,QString NUM_TELEPHONE,QString EMAIL)
{    QFile file ("C:/Users/moezt/Desktop/2021-2022/2A(moez)/2eme semestre/Projet C++/Commande/Realisation_Implementation/GUI_Commande/Historique.txt");
     if (!file.open(QIODevice::WriteOnly|QIODevice::Append | QIODevice::Text))
      qDebug()<<"erreur";
     QTextStream out(&file);
     QString sDate = QDateTime::currentDateTime().toString("dddd dd MMMM yyyy hh:mm:ss.zzz");
     out << CIN+"\n"+NOM << "\n" +NUM_TELEPHONE<< "\n" +EMAIL<< "\n ce client a etait ajouter le " +sDate << "\n";
